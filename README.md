...
- Vintage feel images for cards and logo were found on [Rawpixel](https://www.rawpixel.com/) and [Vecteezy](https://www.vecteezy.com/) color background was applied using GIMP image editing \
...
- Christmas countdown timer counting down days to christmas. Animated snowlike effect added in css. \
...
### Lighthouse Testing
- Lighthouse testing initialy showed lower accessibility as I did not have alt attributes on the images in javascript. I added these and score improved for both mobile and desktop seen below \
<img src="./assets/images/lighthouse_mobile.png" width="300px">
<img src="./assets/images/lighthouse_desktop.png" width="300px">

## BUGS
### Solved Bugs
- It was possible to flip a third card before check for match function started so I added an if statement to the start of my flipcard function if < 2 cards are picked they are pushed into the empty array and if ===2 check for match function begins, else set attribute to snowflake img.
- It was possible to click the same card twice and win a matching pair so I added an if statement to the check for match function, which checked if the card had the same data id the snowflake image would be set as attribute. 
### Unfixed Bugs
